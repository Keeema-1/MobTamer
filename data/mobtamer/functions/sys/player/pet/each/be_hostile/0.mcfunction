...
execute unless score @s mt.hostile_interval matches 1.. if predicate mobtamer:random/500m unless predicate mobtamer:targeting run function mobtamer:sys/player/pet/each/be_hostile/00
execute unless score @s mt.hostile_interval matches 1.. if predicate mobtamer:random/10m if data entity @s {Motion:[0.0d,-0.0784000015258789d,0.0d]} if predicate mobtamer:targeting run function mobtamer:sys/player/pet/each/be_hostile/00

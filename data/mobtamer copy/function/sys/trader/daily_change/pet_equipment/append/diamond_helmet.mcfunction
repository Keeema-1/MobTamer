...
data modify storage mobtamer:temp data.item merge value {sell:{id:"diamond_helmet",Count:1b,tag:{mt_pet_equipment:1b,mt_equipment_part:"head",display:{Name:'[{"translate":"item.minecraft.diamond_helmet","italic":false},{"text": "（ペット用）","italic":false}]'}}}}

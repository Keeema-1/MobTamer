...
execute positioned ~-0.5 ~-0.5 ~-0.5 unless entity @s[dx=0,dy=0,dz=0] positioned ~0.5 ~0.5 ~0.5 facing entity @s feet as @e[team=!,tag=mt.pet_check,limit=1] unless score @s mt.hostile_interval matches 10.. run function mobtamer:sys/player/pet/each/unique/custom_attack/000

...
data modify storage mobtamer:temp data.item merge value {sell:{id:"golden_axe",Count:1b,tag:{mt_pet_equipment:1b,mt_equipment_part:"mainhand",display:{Name:'[{"translate":"item.minecraft.golden_axe","italic":false},{"text": "（ペット用）","italic":false}]'}}}}

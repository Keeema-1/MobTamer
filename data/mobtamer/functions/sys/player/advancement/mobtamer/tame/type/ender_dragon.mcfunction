...
scoreboard players add @s mt.cost 300
scoreboard players add @s mt.tame_type_count 1
data modify storage mobtamer:database data.record.ender_dragon.any set value 1b
...
advancement grant @s only mobtamer:mobtamer/caution/ender_dragon

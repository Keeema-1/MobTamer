...
data merge entity @s {Tags:["mt.pet"],AbsorptionAmount:0f,PersistenceRequired:1b,CustomNameVisible:1b,ArmorDropChances:[0f,0f,0f,0f],HandDropChances:[0f,0f]}
...
scoreboard players set $mt.health mt.score 100000
...
execute store result entity @s Health double 1 run scoreboard players get $mt.health mt.score

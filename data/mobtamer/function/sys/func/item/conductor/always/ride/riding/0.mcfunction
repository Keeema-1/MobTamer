...
execute unless data storage mobtamer:temp data.player{Motion:[0.0d,-0.0784000015258789d,0.0d]} run function mobtamer:sys/func/item/conductor/always/ride/riding/move/0

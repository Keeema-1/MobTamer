...
execute store result entity @s Item.components."minecraft:entity_data".attributes[{id:"minecraft:generic.armor"}].base double 1 run scoreboard players get $mt.pet.armor.base mt.score

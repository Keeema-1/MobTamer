...
data modify storage mobtamer:database data.record.axolotl.any set value 1b
...
advancement grant @s only mobtamer:mobtamer/caution/air
advancement grant @s only mobtamer:mobtamer/caution/bucket

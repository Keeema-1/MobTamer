...
execute if data storage mobtamer:temp data.pet{OnGround:1b} rotated ~ 0 positioned ^ ^ ^0.5 unless block ^ ^ ^ #mobtamer:space align xyz positioned ~-0.5 ~ ~-0.5 if entity @s[dx=1,dy=0,dz=1] run data modify entity @s Motion[1] set value 0.4d
execute if data storage mobtamer:temp data.pet{OnGround:1b} rotated ~ 0 positioned ^ ^ ^0.5 if block ^ ^ ^ #mobtamer:space positioned ^ ^ ^0.5 unless block ^ ^ ^ #mobtamer:space align xyz positioned ~-0.5 ~ ~-0.5 if entity @s[dx=1,dy=0,dz=1] run data modify entity @s Motion[1] set value 0.4d

...
execute unless score $mt.pet_equipment.release_progress mt.score matches 3.. run tellraw @s [{"text": "  ","color": "yellow"},{"translate":"item.minecraft.stone_hoe","color": "yellow"},{"text": "（ペット用）","color": "yellow"}]

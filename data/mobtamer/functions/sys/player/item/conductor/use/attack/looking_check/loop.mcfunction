...
execute positioned ~-1 ~-1 ~-1 as @e[type=#mobtamer:all_mobs,team=!mt.common,dx=1,dy=1,dz=1,limit=1] run function mobtamer:sys/player/item/conductor/use/attack/looking_check/success

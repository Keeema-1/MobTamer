...
data modify storage mobtamer:temp data.item merge value {sell:{id:"leather_boots",Count:1b,tag:{mt_pet_equipment:1b,mt_equipment_part:"feet",display:{Name:'[{"translate":"item.minecraft.leather_boots","italic":false},{"text": "（ペット用）","italic":false}]'}}}}

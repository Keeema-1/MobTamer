...
scoreboard players add @s mt.cost 100
scoreboard players add @s mt.tame_type_count 1
data modify storage mobtamer:database data.record.piglin_brute.any set value 1b
...
advancement grant @s only mobtamer:mobtamer/caution/piglin
advancement grant @s only mobtamer:mobtamer/caution/zombification

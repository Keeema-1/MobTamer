...
data modify storage mobtamer:temp data.item merge value {sell:{id:"leather_leggings",Count:1b,tag:{mt_pet_equipment:1b,mt_equipment_part:"legs",display:{Name:'[{"translate":"item.minecraft.leather_leggings","italic":false},{"text": "（ペット用）","italic":false}]'}}}}

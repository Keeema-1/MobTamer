...
data modify storage mobtamer:temp data.item merge value {sell:{id:"chainmail_boots",Count:1b,tag:{mt_pet_equipment:1b,mt_equipment_part:"feet",display:{Name:'[{"translate":"item.minecraft.chainmail_boots","italic":false},{"text": "（ペット用）","italic":false}]',Lore:['[{"text":"コンダクターで停止させた","italic":false}]','[{"text":"ペットに向かってドロップ","italic":false}]','[{"text":"することで装備させること","italic":false}]','[{"text":"ができます。","italic":false}]']}}}}

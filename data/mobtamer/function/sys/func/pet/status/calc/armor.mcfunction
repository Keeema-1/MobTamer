...
execute store result score #mt.pet.armor mt.score run attribute @s armor get 1
data modify storage mobtamer:temp data.active_effects set from entity @s active_effects
effect clear @s
execute store result score #mt.pet.armor.no_effect mt.score run attribute @s armor get 1
execute store result score #mt.pet.armor.base mt.score run attribute @s armor base get 1
execute store result score #mt.pet.armor.add.variant mt.score run attribute @s armor modifier value get mt.armor.add

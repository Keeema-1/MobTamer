...
# execute store result score #mt.health_modifier mt.score run attribute @s max_health modifier value get mt.max_health.add 100
...
# execute store result score @s mt.cost run data get storage mobtamer:temp data.pet_status.cost.value
    ...
    function mobtamer:sys/func/player/summon/main/0000

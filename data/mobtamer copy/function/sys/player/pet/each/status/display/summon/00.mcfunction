...
execute on origin if entity @s[type=!wither,type=!enderman,type=!elder_guardian,type=!iron_golem,type=!sniffer,type=!guardian,type=!ender_dragon,type=!ghast] run return 1
execute on passengers run data modify entity @s transformation.translation set value [0.0f,0.2f,0.0f]
execute on origin unless entity @s[type=!enderman,type=!iron_golem,type=!guardian] run return 1
...
execute on origin unless entity @s[type=!elder_guardian,type=!sniffer,type=!ender_dragon] run return 1

execute on passengers run data modify entity @s transformation.translation set value [0.0f,1.2f,0.0f]

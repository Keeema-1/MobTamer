...
execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[team=mt.common,tag=mt.player_check,tag=mt.pet,dx=0,dy=0,dz=0,limit=1] run function mobtamer:sys/player/item/conductor/short_sneak/looking_check/success

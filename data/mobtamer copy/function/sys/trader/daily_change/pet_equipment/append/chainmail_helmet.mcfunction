...
data modify storage mobtamer:temp data.item merge value {sell:{id:"chainmail_helmet",Count:1b,tag:{mt_pet_equipment:1b,mt_equipment_part:"head",display:{Name:'[{"translate":"item.minecraft.chainmail_helmet","italic":false},{"text": "（ペット用）","italic":false}]'}}}}

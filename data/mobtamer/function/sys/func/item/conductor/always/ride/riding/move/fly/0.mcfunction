...
function mobtamer:sys/func/item/conductor/always/ride/riding/move/fly/speed/1
execute if entity @s[type=allay] run function mobtamer:sys/func/item/conductor/always/ride/riding/move/fly/speed/2
execute if entity @s[type=ghast] run function mobtamer:sys/func/item/conductor/always/ride/riding/move/fly/speed/3
execute if entity @s[type=vex] run function mobtamer:sys/func/item/conductor/always/ride/riding/move/fly/speed/4
execute if entity @s[type=bat] run function mobtamer:sys/func/item/conductor/always/ride/riding/move/fly/speed/4

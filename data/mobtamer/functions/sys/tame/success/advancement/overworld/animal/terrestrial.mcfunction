...
execute if entity @s[type=polar_bear] run advancement grant @a[tag=mt.advancement_grant] only mobtamer:mobtamer/tame/type/overworld/animal/terrestrial/polar_bear
execute if entity @s[type=wolf] run advancement grant @a[tag=mt.advancement_grant] only mobtamer:mobtamer/tame/type/overworld/animal/terrestrial/wolf
execute if entity @s[type=panda] run advancement grant @a[tag=mt.advancement_grant] only mobtamer:mobtamer/tame/type/overworld/animal/terrestrial/panda
execute if entity @s[type=bee] run advancement grant @a[tag=mt.advancement_grant] only mobtamer:mobtamer/tame/type/overworld/animal/terrestrial/bee
execute if entity @s[type=llama] run advancement grant @a[tag=mt.advancement_grant] only mobtamer:mobtamer/tame/type/overworld/animal/terrestrial/llama
...
execute if entity @s[type=sheep] run advancement grant @a[tag=mt.advancement_grant] only mobtamer:mobtamer/tame/type/overworld/animal/terrestrial/sheep
execute if entity @s[type=bat] run advancement grant @a[tag=mt.advancement_grant] only mobtamer:mobtamer/tame/type/overworld/animal/terrestrial/bat

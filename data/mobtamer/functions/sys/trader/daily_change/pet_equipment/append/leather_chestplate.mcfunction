...
data modify storage mobtamer:temp data.item merge value {sell:{id:"leather_chestplate",Count:1b,tag:{mt_pet_equipment:1b,mt_equipment_part:"chest",display:{Name:'[{"translate":"item.minecraft.leather_chestplate","italic":false},{"text": "（ペット用）","italic":false}]'}}}}

...
scoreboard players set $mt.temp mt.score 209
...
execute if score $mt.random mt.score matches 193..193 run function mobtamer:sys/trader/daily_change/pet_equipment/append/wooden_axe
execute if score $mt.random mt.score matches 194..194 run function mobtamer:sys/trader/daily_change/pet_equipment/append/golden_axe
execute if score $mt.random mt.score matches 195..195 run function mobtamer:sys/trader/daily_change/pet_equipment/append/iron_axe
execute if score $mt.random mt.score matches 196..196 run function mobtamer:sys/trader/daily_change/pet_equipment/append/stone_axe
execute if score $mt.random mt.score matches 197..197 run function mobtamer:sys/trader/daily_change/pet_equipment/append/diamond_axe
execute if score $mt.random mt.score matches 198..198 run function mobtamer:sys/trader/daily_change/pet_equipment/append/diamond_sword
execute if score $mt.random mt.score matches 199..199 run function mobtamer:sys/trader/daily_change/pet_equipment/append/diamond_hoe
execute if score $mt.random mt.score matches 200..200 run function mobtamer:sys/trader/daily_change/pet_equipment/append/diamond_shovel
execute if score $mt.random mt.score matches 201..201 run function mobtamer:sys/trader/daily_change/pet_equipment/append/diamond_pickaxe
execute if score $mt.random mt.score matches 202..202 run function mobtamer:sys/trader/daily_change/pet_equipment/append/diamond_helmet
execute if score $mt.random mt.score matches 203..203 run function mobtamer:sys/trader/daily_change/pet_equipment/append/diamond_chestplate
execute if score $mt.random mt.score matches 204..204 run function mobtamer:sys/trader/daily_change/pet_equipment/append/diamond_leggings
execute if score $mt.random mt.score matches 205..205 run function mobtamer:sys/trader/daily_change/pet_equipment/append/diamond_boots
execute if score $mt.random mt.score matches 206..206 run function mobtamer:sys/trader/daily_change/pet_equipment/append/elytra
execute if score $mt.random mt.score matches 207..207 run function mobtamer:sys/trader/daily_change/pet_equipment/append/trident
execute if score $mt.random mt.score matches 208..208 run function mobtamer:sys/trader/daily_change/pet_equipment/append/turtle_helmet

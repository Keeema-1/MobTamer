...
data modify storage mobtamer:temp data.Item.components."minecraft:custom_data".mobtamer.entity_id set from entity @s data.mobtamer.entity_id

data modify storage mobtamer:temp data.Item.count set value 1

$data modify storage mobtamer:temp data.Item.id set value "$(entity_id)_spawn_egg"

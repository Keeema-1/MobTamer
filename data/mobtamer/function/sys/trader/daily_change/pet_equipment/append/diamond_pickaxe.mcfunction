...
data modify storage mobtamer:temp data.item merge value {sell:{id:"diamond_pickaxe",Count:1b,tag:{mt_pet_equipment:1b,mt_equipment_part:"mainhand",display:{Name:'[{"translate":"item.minecraft.diamond_pickaxe","italic":false},{"text": "（ペット用）","italic":false}]'}}}}

...
execute if entity @s[type=!#mobtamer:size/wide] at @s on passengers if entity @s[tag=mt.target_record_entity] on origin if entity @s[distance=..20] facing entity @s feet positioned ^ ^ ^0.25 run function mobtamer:sys/player/pet/each/unique/custom_attack/00
execute if entity @s[type=#mobtamer:size/wide] at @s on passengers if entity @s[tag=mt.target_record_entity] on origin if entity @s[distance=..20] facing entity @s feet positioned ^ ^ ^0.75 run function mobtamer:sys/player/pet/each/unique/custom_attack/00

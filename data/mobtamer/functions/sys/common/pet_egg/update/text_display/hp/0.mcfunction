...
execute if score $mt.pet.max_health.before mt.score < $mt.pet.power_up_max.max_health mt.score run function mobtamer:sys/common/pet_egg/update/text_display/hp/00
execute unless score $mt.pet.max_health.before mt.score < $mt.pet.power_up_max.max_health mt.score run function mobtamer:sys/common/pet_egg/update/text_display/hp/01

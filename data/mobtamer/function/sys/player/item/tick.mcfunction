...
execute if score @s mt.dropped.fishing_rod matches 1.. run function mobtamer:sys/player/item/drop_fishing_rod
execute if score @s mt.dropped.golden_apple matches 1.. run function mobtamer:sys/func/tame/golden_apple/drop/0
# execute if score @s mt.dropped.enchanted_golden_apple matches 1.. run function mobtamer:sys/player/item/enchanted_golden_apple/drop/0
...
# コンダクターを持っている
    execute if data storage mobtamer:temp data.player.SelectedItem{components:{"minecraft:custom_data":{mt_conductor:1b}}} run function mobtamer:sys/func/item/conductor/hold/0
    execute unless score #mt.use_check mt.score matches 1.. if data storage mobtamer:temp data.player.Inventory[{Slot:-106b,components:{"minecraft:custom_data":{mt_conductor:1b}}}] run function mobtamer:sys/func/item/conductor/hold/0

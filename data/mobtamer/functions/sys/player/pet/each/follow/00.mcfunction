...
# targeting
    ...
    execute if entity @s[type=!ghast,type=!ender_dragon] if score @s mt.strategy = $mt.strategy.attack mt.score if entity @s[tag=mt.targeting] if entity @a[tag=mt.player_check,distance=24..32] run function mobtamer:sys/player/pet/each/follow/000
    execute if entity @s[type=!ghast,type=!ender_dragon] if score @s mt.strategy = $mt.strategy.balance mt.score if entity @s[tag=mt.health.red] if entity @s[tag=mt.targeting] if entity @a[tag=mt.player_check,distance=6..32] run function mobtamer:sys/player/pet/each/follow/000
    execute if entity @s[type=!ghast,type=!ender_dragon] if score @s mt.strategy = $mt.strategy.balance mt.score if entity @s[tag=!mt.health.red] if entity @s[tag=mt.targeting] if entity @a[tag=mt.player_check,distance=24..32] run function mobtamer:sys/player/pet/each/follow/000
    execute if entity @s[type=!ghast,type=!ender_dragon] if score @s mt.strategy = $mt.strategy.recover mt.score if entity @s[tag=mt.health.yellow] if entity @s[tag=mt.targeting] if entity @a[tag=mt.player_check,distance=6..32] run function mobtamer:sys/player/pet/each/follow/000
    execute if entity @s[type=!ghast,type=!ender_dragon] if score @s mt.strategy = $mt.strategy.recover mt.score if entity @s[tag=!mt.health.yellow] if entity @s[tag=mt.targeting] if entity @a[tag=mt.player_check,distance=24..32] run function mobtamer:sys/player/pet/each/follow/000

...
execute if data entity @s Item.tag{mt_pet_equipment:1b,mt_equipment_part:"mainhand"} run function mobtamer:sys/player/pet/each/stop/equip_change/only_mainhand

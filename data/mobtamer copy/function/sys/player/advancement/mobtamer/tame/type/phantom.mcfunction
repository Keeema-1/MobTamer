...
scoreboard players add @s mt.cost 15
scoreboard players add @s mt.tame_type_count 1
data modify storage mobtamer:database data.record.phantom.any set value 1b
...
advancement grant @s only mobtamer:mobtamer/caution/phantom

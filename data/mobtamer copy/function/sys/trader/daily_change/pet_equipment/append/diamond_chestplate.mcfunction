...
data modify storage mobtamer:temp data.item merge value {sell:{id:"diamond_chestplate",Count:1b,tag:{mt_pet_equipment:1b,mt_equipment_part:"chest",display:{Name:'[{"translate":"item.minecraft.diamond_chestplate","italic":false},{"text": "（ペット用）","italic":false}]'}}}}

...
execute on passengers on passengers if entity @s[type=!#mobtamer:weight/light] run tellraw @a[tag=mt.player_check] [{"storage": "mobtamer:text","nbt":"data.ride.too_weight","interpret": true}]

...
data modify storage mobtamer:database data.item.cheat_trader.custom_name set from storage mobtamer:text data.item.cheat_trader.Name
data modify storage mobtamer:database data.item.cheat_trader."entity_data".CustomName set from storage mobtamer:text data.entity_name.cheat_trader
data modify storage mobtamer:database data.item.cheat_trader."entity_data" merge value {CustomNameVisible:1b,NoAI:1b,Tags:["mt.trader","mt.trader.cheat"],PersistenceRequired:1b,Silent:1b,DeathLootTable:"mobtamer:item/cheat_trader"}
data modify storage mobtamer:database data.item.cheat_trader."entity_data".Offers.Recipes set value []
...
execute if data storage mobtamer:settings data.release_progress.gacha{bronze:1b} run data modify storage mobtamer:database data.item.cheat_trader."entity_data".Offers.Recipes append from storage mobtamer:temp data.item

data modify storage mobtamer:temp data.item set value {}
data modify storage mobtamer:temp data.item merge value {buy:{id:"copper_ingot",Count:1b},buyB:{id:"air",Count:0b}}
data modify storage mobtamer:temp data.item merge value {xp:0,priceMultiplier:0f,rewardExp:1b,maxUses:10000}
data modify storage mobtamer:temp data.item merge value {sell:{id:"book",Count:64b}}
data modify storage mobtamer:temp data.item.sell.comopnents merge from storage mobtamer:database data.item.bronze_gacha
execute if data storage mobtamer:settings data.release_progress.gacha{bronze:1b} run data modify storage mobtamer:database data.item.cheat_trader."entity_data".Offers.Recipes append from storage mobtamer:temp data.item
...
data modify storage mobtamer:temp data.item merge value {xp:0,priceMultiplier:0f,rewardExp:1b,maxUses:10000}
data modify storage mobtamer:temp data.item merge value {sell:{id:"book",Count:64b}}
data modify storage mobtamer:temp data.item.sell.comopnents merge from storage mobtamer:database data.item.silver_gacha
execute if data storage mobtamer:settings data.release_progress.gacha{silver:1b} run data modify storage mobtamer:database data.item.cheat_trader."entity_data".Offers.Recipes append from storage mobtamer:temp data.item

data modify storage mobtamer:temp data.item set value {}
data modify storage mobtamer:temp data.item merge value {buy:{id:"copper_ingot",Count:1b},buyB:{id:"air",Count:0b}}
data modify storage mobtamer:temp data.item merge value {xp:0,priceMultiplier:0f,rewardExp:1b,maxUses:10000}
data modify storage mobtamer:temp data.item merge value {sell:{id:"book",Count:64b}}
data modify storage mobtamer:temp data.item.sell.comopnents merge from storage mobtamer:database data.item.gold_gacha
execute if data storage mobtamer:settings data.release_progress.gacha{gold:1b} run data modify storage mobtamer:database data.item.cheat_trader."entity_data".Offers.Recipes append from storage mobtamer:temp data.item

data modify storage mobtamer:temp data.item set value {}
data modify storage mobtamer:temp data.item merge value {buy:{id:"copper_ingot",Count:1b},buyB:{id:"air",Count:0b}}
data modify storage mobtamer:temp data.item merge value {xp:0,priceMultiplier:0f,rewardExp:1b,maxUses:10000}
data modify storage mobtamer:temp data.item merge value {sell:{id:"book",Count:64b}}
data modify storage mobtamer:temp data.item.sell.comopnents merge from storage mobtamer:database data.item.diamond_gacha
execute if data storage mobtamer:settings data.release_progress.gacha{diamond:1b} run data modify storage mobtamer:database data.item.cheat_trader."entity_data".Offers.Recipes append from storage mobtamer:temp data.item
...
data modify storage mobtamer:database data.item.cheat_trader."entity_data".Offers.Recipes append from storage mobtamer:database data.daily.pet_equipment[]

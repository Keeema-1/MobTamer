...
execute if entity @s[type=#mobtamer:size/wide] if entity @s[type=!#mobtamer:size/tall] at @s run function mobtamer:sys/common/pet/tp/wide
execute if entity @s[type=!#mobtamer:size/wide] if entity @s[type=#mobtamer:size/tall] at @s run function mobtamer:sys/common/pet/tp/tall
execute if entity @s[type=#mobtamer:size/wide] if entity @s[type=#mobtamer:size/tall] at @s run function mobtamer:sys/common/pet/tp/wide_tall
